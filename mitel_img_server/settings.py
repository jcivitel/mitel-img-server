...
SECRET_KEY = config("DJANGO_SECRET_KEY", default='django-insecure-ujubm!m8$_f4axy(^g0v^!xd$ck!q7x#(-97_dc*m(a(r6bn!*', cast=str)
...
ROOT_URLCONF = 'mitel_img_server.urls'
...
WSGI_APPLICATION = 'mitel_img_server.wsgi.application'
